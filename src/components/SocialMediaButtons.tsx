  ...
  return (
    scale == "xl" ?
      <div className="flex space-x-10">
        <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="border-r-2 border-gray-300 pr-10 pl-10 text-blue-600 hover:text-blue-800">
        ...
        <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="border-r-2 border-gray-300 pr-10 text-pink-500 hover:text-pink-700">
          <FaInstagram size={size} />
        </a>
        <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="border-r-2 border-gray-300 pr-10 text-blue-700 hover:text-blue-900">
          <FaLinkedinIn size={size} />
        </a>
        <a href="https://www.line.com" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-700 pr-10">
          <FaLine size={size} />
        </a>
      </div>
      : <div className="flex space-x-4">
        ...
        <a href="https://www.line.com" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-700">
          <FaLine size={size} />
        </a>
      </div>
  );
